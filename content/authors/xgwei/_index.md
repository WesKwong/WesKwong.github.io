...
work:
  - position: Research Intern
    company_name: XYZ AI Lab
    company_url: 'https://xyz-lab.ai/'
    company_logo: ''
...
👋 Hi! I'm Xingguang Wei, currently pursuing my Ph.D. at the [University of Science and Technology of China (USTC)](https://en.ustc.edu.cn/). I received my bachelor's degree in Computer Science and Technology from USTC in 2025. I was previously a core member of the [InternVL](https://github.com/OpenGVLab/InternVL) team. My current research focuses on the science of large language model pretraining, while my earlier work centered on multimodal large language models.

**I am actively seeking internship opportunities starting after September 2026, primarily focused on large language model pretraining.**
